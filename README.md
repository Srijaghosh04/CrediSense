...
- **Decision Logic:** Suggest a specific loan amount and interest rate using a transparent, explainable scoring model.
  - _Note:_ The model must explain why it recommended a rejection or a specific limit (e.g., "Rejected due to high litigation risk found in secondary research despite strong GST flows").
...
_(Please note: More details will be provided closer to the hackathon.)_

---

### Project Structure

- **/website** - Frontend application (e.g. portal for Credit Officers)
- **/servers** - Backend services and AI Agents
